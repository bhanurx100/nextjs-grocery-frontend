...
function Header() {
  ...
  // Initialize state from sessionStorage on client-side
  useEffect(() => {
    const storedJwt = typeof window !== "undefined" ? sessionStorage.getItem("jwt") : null;
    const storedUser = typeof window !== "undefined" ? JSON.parse(sessionStorage.getItem("user")) : null;
